...
from VyPy.data.scaling import Linear
from VyPy.data.scaling import Logarithmic


class SemiLogY(ScalingBunch):
    ...
    def calc_scaling(self,Train):
        ...
        XB_scaling = Linear( Xref[0,:,None] , Xref[1,:,None] )
        X_scaling  = Linear( Xref[None,0,:] , Xref[None,1,:] )
        Y_scaling  = Logarithmic( Yref[0], Yref[1] )
        DY_scaling = Linear( DYref[None,0,:]  )
